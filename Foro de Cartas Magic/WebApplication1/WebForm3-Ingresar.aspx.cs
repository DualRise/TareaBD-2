        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    con.Open();
                    SqlCommand sql = new SqlCommand("insert into Usuario(id_grupo,nombre,contraseña,cantidad_comentarios,avatar_url,fecha_nacimiento,sexo,fecha_registro) values('8','" + INombre.Text + "','" + IContraseña.Text + "',0,'" + IUrl.Text + "','" + IFecha.Text + "','" + ISexo.Text + "','" + fecha_actual + "'); ", con);
                    sql.ExecuteNonQuery();
                    con.Close();
